...
Shader "Terrain"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TexCoord8_g24 = i.uv_texcoord * temp_cast_0 + float2( 0,0 );
			float layeredBlendVar51 = i.vertexColor.r;
			float3 layeredBlend51 = ( lerp( UnpackNormal( tex2D( _DirtNormal, uv_TexCoord8_g24 ) ),UnpackNormal( tex2D( _MudNormal, uv_TexCoord8_g24 ) ) , layeredBlendVar51 ) );
			float layeredBlendVar57 = i.vertexColor.b;
			float3 layeredBlend57 = ( lerp( layeredBlend51,UnpackNormal( tex2D( _GrassDirtNormal, uv_TexCoord8_g24 ) ) , layeredBlendVar57 ) );
			o.Normal = layeredBlend57;
			float layeredBlendVar50 = i.vertexColor.r;
			float4 layeredBlend50 = ( lerp( tex2D( _Mud, uv_TexCoord8_g24 ),tex2D( _Dirt, uv_TexCoord8_g24 ) , layeredBlendVar50 ) );
			float layeredBlendVar54 = i.vertexColor.b;
			float4 layeredBlend54 = ( lerp( layeredBlend50,tex2D( _GrassDirt, uv_TexCoord8_g24 ) , layeredBlendVar54 ) );
...
/*ASEBEGIN
Version=14001
-2193;807;1822;1042;2988.32;1507.219;1.189689;True;True
Node;AmplifyShaderEditor.VertexColorNode;6;-2065.305,8.640305;Float;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;69;-2564.118,-1143.141;Float;True;SF_Dirt;0;;24;d7c94d906cf2ff749845754037e31460;0;6;FLOAT3;0;FLOAT3;1;FLOAT3;2;COLOR;3;COLOR;4;COLOR;5
...
Node;AmplifyShaderEditor.CommentaryNode;58;-1999.133,-1454.467;Float;False;510.4386;469.5946;Dirt and Mud;0;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;59;-1369.516,-1449.577;Float;False;327.8551;387.256;Grassy Dirt;0;;1,1,1,1;0;0
WireConnection;50;0;6;1
WireConnection;50;1;69;5
WireConnection;50;2;69;4
WireConnection;51;0;6;1
WireConnection;51;1;69;0
WireConnection;51;2;69;1
WireConnection;54;0;6;3
WireConnection;54;1;50;0
WireConnection;54;2;69;3
WireConnection;41;0;6;2
WireConnection;41;1;42;0
WireConnection;57;0;6;3
WireConnection;57;1;51;0
WireConnection;57;2;69;2
WireConnection;0;0;54;0
WireConnection;0;1;57;0
WireConnection;0;4;41;0
ASEEND*/
//CHKSM=E456076AC761B4203E37DB51D6246F36FBCD4C24