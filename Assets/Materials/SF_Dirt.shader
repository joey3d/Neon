...
Shader "Terrain"
{
	...
	SubShader
	{
		...
		{
			return UnityEdgeLengthBasedTessCull( v0.vertex, v1.vertex, v2.vertex, 5.0,10.0);
		}
		...
		void vertexDataFunc( inout appdata v )
		{
			...
			float4 triplanar98 = TriplanarSamplingSV( _Height1, ase_worldPos, ase_worldNormal, 0.5, 0.1, 0 );
			float4 triplanar99 = TriplanarSamplingSV( _Height2, ase_worldPos, ase_worldNormal, 0.5, 0.3, 0 );
			float lerpResult115 = lerp( triplanar98.x , triplanar99.x , v.color.r);
			float4 triplanar100 = TriplanarSamplingSV( _Height3, ase_worldPos, ase_worldNormal, 0.5, 0.1, 0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 triplanar33_g46 = TriplanarSamplingSNF( _SandNormal, ase_worldPos, ase_worldNormal, 1.0, 0.3, 0 );
			float3 tanTriplanarNormal33_g46 = mul( ase_worldToTangent, triplanar33_g46 );
			float3 triplanar35_g46 = TriplanarSamplingSNF( _Texture2, ase_worldPos, ase_worldNormal, 1.0, 0.1, 0 );
			float3 tanTriplanarNormal35_g46 = mul( ase_worldToTangent, triplanar35_g46 );
			float layeredBlendVar51 = i.vertexColor.r;
			float3 layeredBlend51 = ( lerp( tanTriplanarNormal33_g46,tanTriplanarNormal35_g46 , layeredBlendVar51 ) );
			float3 triplanar36_g46 = TriplanarSamplingSNF( _Texture0, ase_worldPos, ase_worldNormal, 1.0, 0.1, 0 );
			float3 tanTriplanarNormal36_g46 = mul( ase_worldToTangent, triplanar36_g46 );
			float layeredBlendVar57 = i.vertexColor.b;
			float3 layeredBlend57 = ( lerp( layeredBlend51,tanTriplanarNormal36_g46 , layeredBlendVar57 ) );
			o.Normal = layeredBlend57;
			float4 triplanar34_g46 = TriplanarSamplingSF( _Texture3, ase_worldPos, ase_worldNormal, 1.0, 0.1, 0 );
			float4 triplanar32_g46 = TriplanarSamplingSF( _Sand, ase_worldPos, ase_worldNormal, 1.0, 0.3, 0 );
			float layeredBlendVar50 = i.vertexColor.r;
			float4 layeredBlend50 = ( lerp( triplanar34_g46,triplanar32_g46 , layeredBlendVar50 ) );
			float4 triplanar37_g46 = TriplanarSamplingSF( _Texture1, ase_worldPos, ase_worldNormal, 1.0, 0.1, 0 );
			float layeredBlendVar54 = i.vertexColor.b;
			float4 layeredBlend54 = ( lerp( layeredBlend50,triplanar37_g46 , layeredBlendVar54 ) );
			o.Albedo = layeredBlend54.xyz;
			float4 triplanar98 = TriplanarSamplingSF( _Height1, ase_worldPos, ase_worldNormal, 0.5, 0.1, 0 );
			float4 triplanar99 = TriplanarSamplingSF( _Height2, ase_worldPos, ase_worldNormal, 0.5, 0.3, 0 );
			float lerpResult119 = lerp( triplanar98.y , triplanar99.y , i.vertexColor.r);
			float4 triplanar100 = TriplanarSamplingSF( _Height3, ase_worldPos, ase_worldNormal, 0.5, 0.1, 0 );
...
/*ASEBEGIN
Version=14001
164;192;1813;1044;3638.42;-251.7496;1;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;96;-2910.4,96.56913;Float;True;Property;_Height2;Height2;9;0;None;False;white;Auto;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.RangedFloatNode;121;-3030.607,706.7446;Float;False;Constant;_Float2;Float 2;5;0;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;101;-2978.643,550.3487;Float;False;Constant;_Float3;Float 3;4;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;102;-2982.219,905.7043;Float;False;Constant;_Float4;Float 4;4;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LayeredBlendNode;51;-2547.406,-242.4078;Float;False;6;0;FLOAT;0.0;False;1;FLOAT3;0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;59;-1369.516,-1449.577;Float;False;327.8551;387.256;Grassy Dirt;1;54;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;107;-684.765,1038.082;Float;False;Constant;_Float5;Float 5;4;0;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LayeredBlendNode;50;-1896.135,-1233.409;Float;False;6;0;FLOAT;0.0;False;1;FLOAT4;0;False;2;FLOAT4;0.0,0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.LerpOp;120;-840.1445,130.6714;Float;False;3;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;0.0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LayeredBlendNode;57;-2535.533,-245.3836;Float;False;6;0;FLOAT;0.0;False;1;FLOAT3;0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;60,0;Float;False;True;7;Float;ASEMaterialInspector;0;0;Standard;Terrain;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;Back;0;0;False;0;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;0;0;0;0;True;2;15;10;25;True;1;True;0;Zero;Zero;0;Zero;Zero;OFF;OFF;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;False;0;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;FLOAT;0.0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
WireConnection;99;0;96;0
WireConnection;99;3;121;0
...
WireConnection;51;1;123;0
WireConnection;51;2;123;1
WireConnection;50;0;6;1
WireConnection;50;1;123;5
WireConnection;50;2;123;4
WireConnection;119;0;98;2
WireConnection;119;1;99;2
...
WireConnection;54;2;123;3
WireConnection;57;0;6;3
WireConnection;57;1;51;0
WireConnection;57;2;123;2
...
ASEEND*/
//CHKSM=951EC578DE524CA63300F88AF74913A03DAB89E0