...
Shader "Terrain"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata v )
		{
			...
			float4 triplanar98 = TriplanarSamplingSV( _Height1, ase_worldPos, ase_worldNormal, 0.5, 0.2, 0 );
			float4 triplanar99 = TriplanarSamplingSV( _Height2, ase_worldPos, ase_worldNormal, 0.5, 0.2, 0 );
			float lerpResult115 = lerp( triplanar98.x , triplanar99.x , v.color.b);
			float4 triplanar100 = TriplanarSamplingSV( _Height3, ase_worldPos, ase_worldNormal, 0.5, 0.2, 0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 triplanar33_g51 = TriplanarSamplingSNF( _SandNormal, ase_worldPos, ase_worldNormal, 1.0, 0.2, 0 );
			float3 tanTriplanarNormal33_g51 = mul( ase_worldToTangent, triplanar33_g51 );
			float3 triplanar35_g51 = TriplanarSamplingSNF( _Texture2, ase_worldPos, ase_worldNormal, 1.0, 0.2, 0 );
			float3 tanTriplanarNormal35_g51 = mul( ase_worldToTangent, triplanar35_g51 );
			float layeredBlendVar51 = i.vertexColor.r;
			float3 layeredBlend51 = ( lerp( tanTriplanarNormal33_g51,tanTriplanarNormal35_g51 , layeredBlendVar51 ) );
			float3 triplanar36_g51 = TriplanarSamplingSNF( _Texture0, ase_worldPos, ase_worldNormal, 1.0, 0.2, 0 );
			float3 tanTriplanarNormal36_g51 = mul( ase_worldToTangent, triplanar36_g51 );
			float layeredBlendVar57 = i.vertexColor.b;
			float3 layeredBlend57 = ( lerp( layeredBlend51,tanTriplanarNormal36_g51 , layeredBlendVar57 ) );
			o.Normal = layeredBlend57;
			float4 triplanar34_g51 = TriplanarSamplingSF( _Texture3, ase_worldPos, ase_worldNormal, 1.0, 0.2, 0 );
			float4 triplanar32_g51 = TriplanarSamplingSF( _Sand, ase_worldPos, ase_worldNormal, 1.0, 0.2, 0 );
			float layeredBlendVar50 = i.vertexColor.r;
			float4 layeredBlend50 = ( lerp( triplanar34_g51,triplanar32_g51 , layeredBlendVar50 ) );
			float4 triplanar37_g51 = TriplanarSamplingSF( _Texture1, ase_worldPos, ase_worldNormal, 1.0, 0.2, 0 );
			float layeredBlendVar54 = i.vertexColor.b;
			float4 layeredBlend54 = ( lerp( layeredBlend50,triplanar37_g51 , layeredBlendVar54 ) );
			o.Albedo = layeredBlend54.xyz;
			float4 triplanar99 = TriplanarSamplingSF( _Height2, ase_worldPos, ase_worldNormal, 0.5, 0.2, 0 );
			float4 triplanar98 = TriplanarSamplingSF( _Height1, ase_worldPos, ase_worldNormal, 0.5, 0.2, 0 );
			float lerpResult119 = lerp( triplanar99.y , triplanar98.y , i.vertexColor.r);
			float4 triplanar100 = TriplanarSamplingSF( _Height3, ase_worldPos, ase_worldNormal, 0.5, 0.2, 0 );
...
/*ASEBEGIN
Version=14001
7;29;1813;1044;2504.225;12.58176;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;101;-2978.643,550.3487;Float;False;Constant;_Float3;Float 3;4;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;102;-2982.219,907.0957;Float;False;Constant;_Float4;Float 4;4;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;129;-2768.419,-708.3405;Float;True;SF_Dirt;0;;51;d7c94d906cf2ff749845754037e31460;0;6;FLOAT3;0;FLOAT3;1;FLOAT3;2;FLOAT4;3;FLOAT4;4;FLOAT4;5
...
Node;AmplifyShaderEditor.RangedFloatNode;121;-3036.172,706.7446;Float;False;Constant;_Float2;Float 2;5;0;0.1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6C2EE04B8C81080CDAA065229BF7BD5A4C6BD39C