...
Shader "Terrain"
{
	...
	SubShader
	{
		...
		{
			return UnityEdgeLengthBasedTessCull( v0.vertex, v1.vertex, v2.vertex, 3.0,8.0);
		}
		...
		void vertexDataFunc( inout appdata v )
		{
			...
			float4 triplanar98 = TriplanarSamplingSV( _Height1, ase_worldPos, ase_worldNormal, 0.5, 0.4, 0 );
			float4 triplanar99 = TriplanarSamplingSV( _Height2, ase_worldPos, ase_worldNormal, 0.5, 0.4, 0 );
			float lerpResult115 = lerp( triplanar98.x , triplanar99.x , v.color.b);
			float4 triplanar100 = TriplanarSamplingSV( _Height3, ase_worldPos, ase_worldNormal, 0.5, 0.4, 0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 triplanar33_g51 = TriplanarSamplingSNF( _SandNormal, ase_worldPos, ase_worldNormal, 1.0, 0.4, 0 );
			float3 tanTriplanarNormal33_g51 = mul( ase_worldToTangent, triplanar33_g51 );
			float3 triplanar35_g51 = TriplanarSamplingSNF( _Texture2, ase_worldPos, ase_worldNormal, 1.0, 0.4, 0 );
			...
			float3 triplanar36_g51 = TriplanarSamplingSNF( _Texture0, ase_worldPos, ase_worldNormal, 1.0, 0.4, 0 );
			...
			float4 triplanar34_g51 = TriplanarSamplingSF( _Texture3, ase_worldPos, ase_worldNormal, 1.0, 0.4, 0 );
			float4 triplanar32_g51 = TriplanarSamplingSF( _Sand, ase_worldPos, ase_worldNormal, 1.0, 0.4, 0 );
			float layeredBlendVar50 = i.vertexColor.r;
			float4 layeredBlend50 = ( lerp( triplanar34_g51,triplanar32_g51 , layeredBlendVar50 ) );
			float4 triplanar37_g51 = TriplanarSamplingSF( _Texture1, ase_worldPos, ase_worldNormal, 1.0, 0.4, 0 );
			...
			float4 triplanar99 = TriplanarSamplingSF( _Height2, ase_worldPos, ase_worldNormal, 0.5, 0.4, 0 );
			float4 triplanar98 = TriplanarSamplingSF( _Height1, ase_worldPos, ase_worldNormal, 0.5, 0.4, 0 );
			float lerpResult119 = lerp( triplanar99.y , triplanar98.y , i.vertexColor.r);
			float4 triplanar100 = TriplanarSamplingSF( _Height3, ase_worldPos, ase_worldNormal, 0.5, 0.4, 0 );
...
/*ASEBEGIN
Version=14001
-3015;740;1808;1044;1164.075;-399.5207;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;101;-3219.643,408.9487;Float;False;Constant;_Float3;Float 3;4;0;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;107;-684.765,1038.082;Float;False;Constant;_Float5;Float 5;4;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-612.1498,1183.45;Float;False;Constant;_Float0;Float 0;4;0;8;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=90DF2F8398AEF2CB2E30C3229548F6D9F015349F