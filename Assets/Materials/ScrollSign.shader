    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_5887 = _Time;
                float2 node_9810 = (sceneUVs.rg+node_5887.g*float2(0.1,0));
                float4 _SFSUCKS_var = tex2D(_SFSUCKS,TRANSFORM_TEX(node_9810, _SFSUCKS));
                float node_4510 = (_SFSUCKS_var.r*_Clip);
                clip(node_4510 - 0.5);
////// Lighting:
////// Emissive:
                float2 node_8951 = (i.uv0+node_5887.g*float2(0.1,0));
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                float2 sceneUVs = (i.projPos.xy / i.projPos.w);
                float4 node_190 = _Time;
                float2 node_9810 = (sceneUVs.rg+node_190.g*float2(0.1,0));
                float4 _SFSUCKS_var = tex2D(_SFSUCKS,TRANSFORM_TEX(node_9810, _SFSUCKS));
                float node_4510 = (_SFSUCKS_var.r*_Clip);
                clip(node_4510 - 0.5);
