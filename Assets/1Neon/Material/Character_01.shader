...
#define _E_Intensity_arr NewAmplifyShader
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( _E_Color_Instance * ( ( tex2DNode4.b + ( tex2D( _E, panner13 ).g * ( tex2D( _E, panner5 ).r * tex2D( _E, uv_TexCoord6 ).b ) ) ) * _E_Intensity_Instance ) ).rgb;
...
/*ASEBEGIN
Version=14001
-1791;117;1426;824;3589.96;1215.471;2.92;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;8;-3152.218,682.8381;Float;True;Property;_E;E;3;0;Assets/1Neon/Textures/Character/Character_01_A.png;False;white;Auto;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.SamplerNode;10;-2830.684,933.1874;Float;True;Property;_TextureSample0;Texture Sample 0;5;0;Assets/1Neon/Textures/Character/Character_01_A.png;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;3;-2831.026,358.8129;Float;True;Property;_TextureSample2;Texture Sample 2;2;0;Assets/1Neon/Textures/Character/Character_01_A.png;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-1782.481,43.0487;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=6BBA8F1A795C194BEBC99D1F9B0F1119DB499A21